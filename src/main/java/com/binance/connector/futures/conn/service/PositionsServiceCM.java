...
import com.binance.connector.futures.conn.actions_cm.PositionInformationCM;
 ...
 */
public class PositionsServiceCM {
  ...
  public static String[][] getOpenPositions() {
    String openPos = PositionInformationCM.getAllPositions();
